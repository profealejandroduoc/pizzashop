                        ...
                        <Card className="border-0 shadow-sm mb-4">
                            <Card.Body className="p-0">
                                <ListGroup variant="flush">
                                    {cart.map((item) => (
                                        <ListGroup.Item key={item.id} className="d-flex align-items-center justify-content-between p-4 border-bottom">
                                            ...
                                            <div className="d-flex align-items-center">
                                                <div className="d-flex align-items-center border rounded-pill px-2 py-1 me-4 bg-light">
                                                    <Button variant="link" className="text-dark p-0 text-decoration-none" size="sm" onClick={() => decreaseQuantity(item.id)}>
                                                        <i className="bi bi-dash"></i>
                                                    </Button>
                                                    <span className="mx-3 fw-bold">{item.count}</span>
                                                    <Button variant="link" className="text-dark p-0 text-decoration-none" size="sm" onClick={() => increaseQuantity(item.id)}>
                            ...
                            <Card.Body className="p-4">
                                ...
                                {isAuthenticated ? (
                                    ...
                                    <div className="text-center">
                                        ...
                                        <Button variant="secondary" size="lg" className="w-100 fw-bold" disabled>Ir a Pagar</Button>
                                    </div>
                                )}
                            </Card.Body>
                        </Card>
